...
Future<DateTime?> showQuarterPicker({
  ...
  return await showDialog<DateTime>(
    context: context,
    builder: (context) => _QuarterPickerDialog(
...
class _QuarterPickerDialog extends StatefulWidget {
  final DateTime? initialDate, firstDate, lastDate;
  final MaterialLocalizations localizations;
  final Locale? locale;

  const _QuarterPickerDialog({
    Key? key,
  ...
  @override
  _QuarterPickerDialogState createState() => _QuarterPickerDialogState();
}

class _QuarterPickerDialogState extends State<_QuarterPickerDialog> {
  final GlobalKey<YearSelectorState> _qtrSelectorState = new GlobalKey();
  ...
  void _onUpButtonPressed() {
    if (_qtrSelectorState.currentState != null) {
      _qtrSelectorState.currentState!.goUp();
    } else {
  ...
  void _onDownButtonPressed() {
    if (_qtrSelectorState.currentState != null) {
      _qtrSelectorState.currentState!.goDown();
    } else {
